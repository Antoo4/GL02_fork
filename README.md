...
├── src/
│   └── services/
│       └── selectionner.js        # EF03 - Sélection de questions
├── spec/
│   └── selection.spec.js          # Tests EF03
├── data/
│   └── 1_sample.gift              # Fichier GIFT d'exemple
├── Question.js                     # Classe Question
├── GIFTParser.js                  # Parser GIFT principal
├── GIFTParser(2).js               # Version avancée du parser
├── SimulateExam.js                # EF06 - Simulation d'examen
├── caporalCli.js                  # CLI principal (display, search)
├── caporalCli(1).js               # CLI VCard (EF05)
├── caporalCli(2).js               # Version alternative du CLI
├── caporalCli(3).js               # Version alternative du CLI
├── caporalCli(4).js               # Version alternative du CLI
